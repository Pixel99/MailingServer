...
<table width="1291" border="1" align="center">
  ...
  <%
	...
	try
	{
		...
		ResultSet rs = st.executeQuery("select * from userdata_sentmails");
		if(rs!=null)
		{
			while(rs.next())
			{
				if(rs.getString(1).equals(session.getAttribute("email")))
				{
		...
		{
			out.println("<tr><td align=center>Sent MailBox is empty</td></tr>");
		}
	}
	catch(Exception e)
	{
